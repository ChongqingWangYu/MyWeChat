package com.wangyu.wx.util;

import com.wangyu.wx.common.MessageType;
...
/**
 * @ClassName MessageHandlerUtil
 * @Description 消息处理工具类
 * @Author ChongqingWangYu
 * @DateTime 2019/2/26 21:26
...
public class MessageHandlerUtil {
    ...
    private static String handleTextMessage(Map<String, String> map) {
        ...
        switch (content) {
            case "1":
            case "文本":
                String msgText = "ChongqingWangYu学习了微信开发！\n" +
                        "<a href=\"https://github.com/ChongqingWangYu\">重庆王渔的GitHub</a>";
            ...
            case "音乐":
                ...
                music.musicUrl = "http://thrn38.ngrok.natapp.cn/media/music/music.mp3";
                music.hqMusicUrl = "http://thrn38.ngrok.natapp.cn/media/music/music.mp3";
